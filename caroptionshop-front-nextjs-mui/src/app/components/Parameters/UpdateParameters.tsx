...
const UpdateParameter = ({
  ...
  const [category, setCategory] = useState(parameter?.group);
  const [parameterGroup, setParameterGroup] = useState(parameter?.group);
  ...
  return (
    <>
      ...
      >
        ...
        {(parameterType === "SELECTONE" || parameterType === "SELECTMORE") && (
          <TextField
            name="values"
